...
def propagation(atmFactors, results):
    #atmFactors[godzina][czynnik]
    #0 temp, 1 predkosc wiatru, 2 kierunek wiatru, 3 opad
    for i in range (0,5):
        #jak temperatura > -5 to 
        wind = int(atmFactors[0][1])
        ...
        if wind < 5 and wind > 0:
            ...
            if atmFactors[0][2] == "NE" or atmFactors[0][2] == "SE":
                atmFactors[0][2] = "E"
            elif atmFactors[0][2] == "NW" or atmFactors[0][2] == "SW":
                atmFactors[0][2] = "W"
